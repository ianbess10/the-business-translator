...
def main():
 lineage=json.loads((W/'certification/inherited-contract-lineage-v1.7.json').read_text()); assert lineage['status']=='accepted_no_new_provider_call_required' and lineage['changed_provider_contract_count']==0 and lineage['new_certification_call_count']==0
 ...
 print('evidence_gated_v1_7_contract_lineage_passed: 2/2 provider contracts byte-identical to certified lineage; 0 new calls required'); return 0
