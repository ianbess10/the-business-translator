...
def main():
 ...
 assert not (P/'results/evidence-gated-v1.6').exists()
 print('evidence_gated_v1_6_paths_passed: 24 frozen routing paths and 8 deterministic approved-rulebook mappings without labels'); return 0
