...
def main():
 ...
 assert not (P/'results/evidence-gated-v1.5').exists()
 print('evidence_gated_v1_5_paths_passed: 24 frozen routing paths and 8 deterministic approved-rulebook mappings without labels'); return 0
