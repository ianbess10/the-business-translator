...
| ID | Official source | Recorded status | Project use |
|---|---|---|---|
| SA-CONDUCT-001 | [Financial Sector Regulation Act 9 of 2017 — South African Government](https://www.gov.za/documents/financial-sector-regulation-act-9-2017-english-sepedi-22-aug-2017-0000) | Legislation page with commencement and amendment references | Statutory anchor for the FSCA and market-conduct framework |
| SA-CONDUCT-002 | [FSCA Supervisory Information](https://www.fsca.co.za/Supervisory-Information) | Official regulatory portal | Entry point for applicable legislation, standards, joint standards, directives, guidance notices and interpretation rulings |
| SA-CONDUCT-003 | [FSCA 2026 three-year regulation plan](https://www.fsca.co.za/Supervisory-Information?collapse=collapseSixteen) | Official regulatory plan | Change horizon and prioritisation only; not a binding obligation by itself |
...
A source may enter the evaluation corpus only when its record includes:

1. issuing authority;
2. official title and source URL;
3. instrument type and legal/status classification;
4. publication, effective and relevant transition dates where applicable;
5. version or amendment position;
6. applicability conditions;
7. supersession or withdrawal check;
8. approved source excerpt and locator; and
9. human reviewer approval.

## Refresh triggers

Re-verify the register when:

- the FIC or FSCA publishes a new or amended instrument;
- a draft becomes final, is withdrawn or is replaced;
- commencement or transition dates change;
- the synthetic institution profile changes;
- a new licence, product, entity or distribution channel enters scope; or
- an evaluation run is about to be represented as current.

Official-source verification does not itself establish how an instrument applies to any real institution.
